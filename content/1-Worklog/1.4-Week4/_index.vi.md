...
| 7 - CN | - **Thực hành nâng cao:** <br>&emsp; + Khởi tạo lại EC2 instance và cấu hình Security Group <br>&emsp; + Kết nối SSH và cài đặt Web Server (Apache/Nginx) <br>&emsp; + Triển khai web đơn giản và truy cập qua Public IP | 16/05/2026 | 17/05/2026 | <https://cloudjourney.awsstudygroup.com/> |
